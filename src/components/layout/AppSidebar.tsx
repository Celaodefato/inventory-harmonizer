import { LayoutDashboard, Settings, FileText, AlertTriangle, Server, UserX, LogOut, User, Users, Key, ShieldCheck, Monitor } from 'lucide-react';
...
const navigation = [
  ...
  { name: 'Conformidade', href: '/user-compliance', icon: ShieldCheck },
